...
<nav id="navBar" class="navbar fixed-top navbar-expand-lg navbar" style="padding: 10px 50px;">
    ...
    <div class="container-our-blog" id="all-blog">
        <h2 style="font-size: 25px; color: #2F200A; font-weight: 700;">Manage Blog</h2>
    </div>
        ...
        <table id="blogTable" class="table">
          ...
          $articles = $stmt->fetchAll();
            ...
            foreach ($articles as $article) {
                ?>  
                <tr>
                    <td data-label="Name Blog"><?php echo $article['title']; ?></td>
                    <td data-label="type"><?php echo $article['categories']; ?></td>

                    <td data-label="Option">
                        <a class="btn-diy" href="views.php?view_id=<?php echo $article['id_article']; ?>">View</a>
                        <a class="btn-diy" href="edit-blog.php?update_id=<?php echo $article['id_article']; ?>">Edit</a>
                        <a data-id="<?php echo $article['id_article']; ?>" href="?delete=<?php echo $article['id_article']; ?>" class="link-txt delete-btn">Delete</a>
                    </td>
                </tr>
        <?php } ?>
            </tbody>        
                                    ...
                                    $.ajax({
                                        ...
                                        .done(function() {
                                            Swal.fire({
                                                ...
                                                document.location.href = 'manage-blog.php';
                                            })
                                        })
                                        .fail(function() {
